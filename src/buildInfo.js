/**
 * Horodatage de la dernière mise à jour du code déployé, en heure locale de
 * Bruxelles (CET/CEST, pas UTC). Ce site est statique (pas de véritable
 ...
 */
const AMGT4CEM_BUILD_TIMESTAMP = '20260925-1528';
